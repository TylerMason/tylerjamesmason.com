...
const cardData = [
    { title: "Project 1", imageUrl: "/images/bluenight.gif", href: "/project1" },
    { title: "Card 2", imageUrl: "/images/collosus.gif", href: "/Map/mapindex" },
    { title: "Card 3", imageUrl: "/images/greendeath.gif", href: "/project3" },
    { title: "Card 4", imageUrl: "/images/lushwaterfalls.gif", href: "/project4" },
